...
export default function SettingsPanel() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, zIndex: 50, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.5)', backdropFilter: 'blur(10px)' }}
      ...
      <div onClick={e => e.stopPropagation()}
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 24px', borderBottom: '1px solid var(--divider)' }}>
          ...
          <button onClick={() => setOpen(false)}
            ...
            onMouseEnter={e => { const b = e.currentTarget as HTMLButtonElement; b.style.background = 'rgba(0,0,0,0.08)'; b.style.color = 'var(--t1)' }}
